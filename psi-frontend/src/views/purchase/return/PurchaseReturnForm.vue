...
import PurchaseReturnDetailDialog from './PurchaseReturnDetailDialog.vue'
...
const onImportData = (rows: any[]) => {
  const mapped: RowData[] = rows.map((r, i) => ({
    ...
    billNo: r.billNo ?? r.单据编号 ?? 'CGTH' + Date.now() + i,
