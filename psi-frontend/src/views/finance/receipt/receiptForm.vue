  ...
  <div class="receipt-report page-container">
    ...
    >
      ...
      >
        ...
        <el-table-column prop="code" label="客户编号" width="120"></el-table-column>
        <el-table-column prop="category" label="客户类别" width="120"></el-table-column>
...
import ReceiptFormDetail from '@/views/finance/receipt/receiptFormDetail.vue'
...
const demoRows: TableRow[] = [
  {
    ...
    data: '测试备注信息',
    billData: [
      { extension: { type: '销售单' }, time: '2024-10-10', sourceData: { number: 'XS20241010001' }, money: 5000.00 }
    ],
    recordData: [
  ...
  },
  {
    ...
    data: '',
    billData: [
      { extension: { type: '销售单' }, time: '2024-10-11', sourceData: { number: 'XS20241011001' }, money: 1500.00 }
    ],
    recordData: [
...
const handleCustomerRowClick = (row: any) => {
  ...
  if (index > -1) {
    ...
    customerSelection.value = [row]; // 单选模式，只保留一个选中项
  }
};
...
const fetchData = async () => {
  ...
  try {
    ...
    //   page: page.current,
    //   limit: page.size,
    //   customer: searchForm.customerId,
    ...
    // };
    // const res = await http.post('/receipt/record', params);
