...
/**
 * @Author 唐怀瑟
 * @Data 2025/10/19 19:14
 * @PackageName: com.zeroone.star.project.dto.j3.purchase
 * @CLASSNAME: PurchaseOrderDetailDTO
 * @Description: 获取指定采购订单详情
 * @Version 1.0
 */
...
public class PurchaseOrderDetailDTO {
    ...
    @Digits(integer = 12, fraction = 4, message = "入库数量整数部分最多12位，小数部分最多4位")
    ...
    private String data;
    @ApiModelProperty(value = "获取指定采购订单其他部分详情", example = "略")
    private PurchaseOrderOtherDetailDTO purchaseOrderOtherDetailDTO;
}
