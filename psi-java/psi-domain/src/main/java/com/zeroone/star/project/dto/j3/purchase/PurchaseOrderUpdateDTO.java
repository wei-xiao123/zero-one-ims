...
public class PurchaseOrderUpdateDTO {
     ...
     * 采购订单编号
     */
    @ApiModelProperty(value = "采购订单id编号", example = "1983381181546139789")
    private String id;

    /**
     * 关联单据 | Sor
     */
    @ApiModelProperty(value = "关联单据 | Sor", example = "1983381181546139456")
    ...
    @ApiModelProperty(value = "供应商", example = "1983381181546139123", required = true)
    ...
    @ApiModelProperty(value = "单据金额", example = "11", required = true)
    ...
    @ApiModelProperty(value = "实际金额", example = "10", required = true)
    ...
    @ApiModelProperty(value = "关联人员", example = "1983381181546139852", required = true)
